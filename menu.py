...
total_line_cost = [order["Price"] * order["Quantity"] for order in place_order]
sum_total = sum(total_line_cost)
print(f"Your total cost for your order is ${sum_total:.2f}")
